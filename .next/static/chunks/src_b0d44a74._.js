...
const getAuthorName = (authorId)=>{
    const user = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.id === authorId);
...
const publishedPosts = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockPosts"].filter((post)=>post.status === 'published').map((post)=>({
        ...post,
...
function BlogIndexPage() {
    ...
    const [posts, setPosts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(publishedPosts);
        ...
        "BlogIndexPage.useEffect": ()=>{
            if (searchTerm) {
                ...
                const filteredPosts = publishedPosts.filter({
                    "BlogIndexPage.useEffect.filteredPosts": (post)=>post.title.toLowerCase().includes(searchTerm.toLowerCase()) || post.excerpt.toLowerCase().includes(searchTerm.toLowerCase())
                }["BlogIndexPage.useEffect.filteredPosts"]);
...
_s(BlogIndexPage, "25jKwqD0hQoeDeAi34eJRDSgo+8=", false, function() {
    return [
...
//# sourceMappingURL=src_b0d44a74._.js.map