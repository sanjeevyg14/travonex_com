...
const AuthProvider = ({ children })=>{
            ...
            try {
                ...
                if (storedUser) {
                    ...
                    const mockUser = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find({
                        "AuthProvider.useEffect.mockUser": (u)=>u.email === parsedUser.email
                    }["AuthProvider.useEffect.mockUser"]);
                    if (mockUser) {
    ...
    }["AuthProvider.useEffect"], []); // The empty dependency array ensures this runs only once on mount.
    ...
    const updateUserSession = (newUser)=>{
        ...
        if (newUser) {
            ...
            const mockUser = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.email === newUser.email);
    ...
    const signup = async (email, password, name)=>{
        ...
        const existingUser = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.email === email);
        if (existingUser) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].push(newMockUser);
    ...
    const login = async (email, password)=>{
        ...
        const mockUser = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.email === email);
        if (!mockUser) {
    ...
    const loginWithGoogle = async ()=>{
        ...
        const googleUser = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.role === 'user');
        if (googleUser) {
            const userToLogin = {
                uid: googleUser.id,
...
_s(AuthProvider, "RycNjMTUkbCxaGDR7B6oC1tdqA8=", false, function() {
    return [
...
//# sourceMappingURL=src_6c7afc16._.js.map