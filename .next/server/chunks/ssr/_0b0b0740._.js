...
const metadata = {
    ...
    keywords: [
        ...
        'adventure travel',
        'backpacking India',
        'verified trip organizers',
        'travel communities',
        'Bangalore weekend trips',
        'India travel aggregator',
        'stress-free travel',
        'solo travel groups',
        'hiking trips',
        'bike trips',
    ...
    openGraph: {
        ...
        url: 'https://www.travonex.com',
        siteName: 'Travonex',
        images: [
            {
                url: 'https://www.travonex.com/og-image.jpg',
                width: 1200,
                height: 630,
    ...
    twitter: {
        ...
        images: [
            'https://www.travonex.com/twitter-image.jpg'
        ]
    },
...
function RootLayout({ children }) {
    return(// The `lang="en"` attribute is important for accessibility and SEO.
...
//# sourceMappingURL=_0b0b0740._.js.map