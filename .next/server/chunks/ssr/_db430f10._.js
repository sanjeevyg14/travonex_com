...
// In a real app, you would fetch this data from a service like Firestore.
__turbopack_context__.s({
    "addComment": (()=>addComment),
    "addFollowUpStory": (()=>addFollowUpStory),
    "deleteComment": (()=>deleteComment),
    "deleteFollowUpStory": (()=>deleteFollowUpStory),
    "deletePost": (()=>deletePost),
    "mockComments": (()=>mockComments),
    "mockFollowUpStories": (()=>mockFollowUpStories),
    "mockPosts": (()=>mockPosts),
    "mockUsers": (()=>mockUsers),
...
let mockComments = [
    {
        ...
        postId: 'post-1',
        userId: 'user-4',
        comment_text: 'Great article! The mountain views look absolutely stunning.',
        status: 'approved',
        created_at: new Date()
    },
    {
        ...
        postId: 'post-1',
        userId: 'user-2',
        comment_text: 'I really need to go there. Thanks for the inspiration!',
        status: 'pending',
        created_at: new Date()
    }
];
let mockFollowUpStories = [
    {
        id: 'story-1',
        postId: 'post-1',
        userId: 'user-3',
        story_text: 'Inspired by this post, I went on my own mountain adventure. It was a transformative experience. The air was so fresh and the views were just breathtaking.',
        status: 'approved',
        image_url: 'https://picsum.photos/seed/story-hike/400/200',
        created_at: new Date()
    },
    {
        id: 'story-2',
        postId: 'post-1',
        userId: 'user-4',
        story_text: 'This is my follow up story, it is still pending approval.',
        status: 'pending',
        created_at: new Date()
    }
];
...
function updatePost(postId, updates) {
    mockPosts = mockPosts.map((p)=>p.id === postId ? {
            ...p,
            ...updates,
            updated_at: new Date()
        } : p);
...
function addFollowUpStory(story) {
    const newStory = {
        ...story,
        id: `story-${Date.now()}`,
        status: 'pending',
...
function deleteFollowUpStory(storyId) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$blog$2f$interactive$2d$section$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/blog/interactive-section.tsx [app-rsc] (ecmascript)");
...
async function getBlogPostBySlug(slug) {
    const post = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["mockPosts"].find((p)=>p.slug === slug);
    if (!post || post.status !== 'published') {
        return null;
    }
    const author = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.id === post.authorId);
    return {
        ...post,
...
async function getRelatedPosts(categoryId, currentPostId) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["mockPosts"].filter((p)=>p.status === 'published' && p.category === categoryId && p.id !== currentPostId).slice(0, 3);
}
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
                        ...
                        children: [
                            ...
                            post.featured_img && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Card"], {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["CardHeader"], {
                                                        className: "p-0",
                                                        children: relatedPost.featured_img && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_db430f10._.js.map