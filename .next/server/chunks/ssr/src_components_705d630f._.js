...
const getUser = (userId)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.id === userId);
function InteractiveSection({ articleId }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        setComments(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockComments"].filter((c)=>c.postId === articleId && c.status === 'approved'));
        setStories(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockFollowUpStories"].filter((s)=>s.postId === articleId && s.status === 'approved'));
    }, [
        articleId
    ]);
    // This function will be passed to the modal to update the UI upon submission
    const onSubmission = ()=>{
    // Just toast for now, as new submissions are 'pending' and won't show up here anyway.
    // A more complex implementation could show a "pending review" message.
    };
    if (loading) {
...
function SubmissionModal({ type, articleId, onSubmission }) {
    ...
    const handleSubmit = (e)=>{
        ...
        if (isComment) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addComment"])({
                postId: articleId,
                userId: user.uid,
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addFollowUpStory"])({
                postId: articleId,
                userId: user.uid,
                story_text: content,
                image_url: imagePreview || undefined
...
//# sourceMappingURL=src_components_705d630f._.js.map